...
<div id="layout">
    ...
    <div id="menu">
        <div class="pure-menu pure-menu-open">
            ...
            <ul>
                ...
                <li class="menu-item-divided pure-menu-selected"><a href="algebra.php">Logical Plan</a></li>
    ...
    <div id="main">
        ...
        <div class="content">
            <p><p><p>
            <img src="../paxquery-installation/web/images/plans/xoutput-optimized-LogPlan.png" alt="" style="display: block; margin-left: auto; margin-right: auto"/>
        </div>
    </div>
</div>
