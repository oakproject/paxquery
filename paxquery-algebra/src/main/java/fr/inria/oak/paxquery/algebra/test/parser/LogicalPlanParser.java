...
public class LogicalPlanParser implements LogicalPlanParserConstants {
    ...
    private LogicalPlanParser(String strPlan, boolean fromString) throws Exception {
        this(new ByteArrayInputStream(strPlan.getBytes()));
    }

    public static BaseLogicalOperator parseString(String strPlan) throws Exception {
        LogicalPlanParser parser = new LogicalPlanParser(strPlan, true);
        parser.Start();
        return parser.logOp;
    }
