...
/**
 * Conjunctive left outer equi-join operator in PACT.
 * 
 */
public class ConjLOEquiJoinOperator extends BaseCoGroupJoinOperator {
	...
	public void coGroup(Iterator<Record> records1, Iterator<Record> records2, Collector<Record> collector) {
		conjLOEquiJoin(this.inputRecordsSignature1, records1, this.inputRecordsSignature2, records2,
				this.nullRecord, collector);
	}
	 ...
	 * @param collector
	 */
	public static void conjLOEquiJoin(NestedMetadata inputRecordsSignature1, Iterator<Record> records1, NestedMetadata inputRecordsSignature2, Iterator<Record> records2, 
			Record nullRecord, Collector<Record> collector) {
		coGroupJoin(inputRecordsSignature1, records1, inputRecordsSignature2, records2, 
				null, 0, true, nullRecord, false, collector);
	}
